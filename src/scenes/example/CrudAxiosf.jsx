...
export const CreateNewAccountModal = ({ open, columns, onClose, onSubmit ,ciudadData,inicialUser:inicial}) => {
  ...
  const handleChange = name => event => {
    ...
    //console.log(event.target.value.nameState);
    console.log(event.target.value.nombre);
    
    formik.setFieldValue("state", event.target.value.nombre);
        ...
        <DialogContent>
          <form onSubmit={formik.handleSubmit}>
            ...
            <TextField
                ...
                >  
                  {/*
                  {statescid.map(option => (
                    <MenuItem key={option.id} value={option}>
                      {option.id} ({option.nameState})
                    </MenuItem>
                  ))}
                   */}
