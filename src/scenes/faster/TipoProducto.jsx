...
import { inicialTipoProducto} from '../../data/makeDataCrud';
...
const API_SEL=process.env.REACT_APP_API_SEL_TPR;
const API_INS=process.env.REACT_APP_API_INS_TPR;
const API_UPD=process.env.REACT_APP_API_UPD_TPR;
const API_DEL=process.env.REACT_APP_API_DEL_TPR;
...
const TipoProducto = () => {
    ...
    const [inicial, setInicial] = useState(inicialTipoProducto); 
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialTipoProducto.title);
   setSubTitle(inicialTipoProducto.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
        ...
        renderTopToolbarCustomActions={() => (
          <Button
            ...
            onClick={() => {
              ...
              setInicial(inicialTipoProducto);
