...
import { inicialCentroConsumo} from '../../data/makeDataCrud';
...
const API_SEL=process.env.REACT_APP_API_SEL_CCO;
const API_INS=process.env.REACT_APP_API_INS_CCO;
const API_UPD=process.env.REACT_APP_API_UPD_CCO;
const API_DEL=process.env.REACT_APP_API_DEL_CCO;
...
const CentroConsumo = () => {
    ...
    const [inicial, setInicial] = useState(inicialCentroConsumo); 
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialCentroConsumo.title);
   setSubTitle(inicialCentroConsumo.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
        ...
        renderTopToolbarCustomActions={() => (
          <Button
            ...
            onClick={() => {
              ...
              setInicial(inicialCentroConsumo);
