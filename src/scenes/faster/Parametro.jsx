...
import {ModalParametro} from './modal/ModalParametro';

//import esUnico   from './helpers/esUnico';
import { AuthContext } from "../../mycontext";

const URL_BASE=process.env.REACT_APP_URL_BASE;
const API_SEL=process.env.REACT_APP_API_SEL_PAR;
const API_INS=process.env.REACT_APP_API_INS_PAR;
const API_UPD=process.env.REACT_APP_API_UPD_PAR;
const API_DEL=process.env.REACT_APP_API_DEL_PAR;
...
const Parametro = () => {
    ...
    const [inicial, setInicial] = useState(inicialParametro); 
    ...
    const handleCreateNewRow = (values) => {
          ...
          axios
              .post(`${URL_BASE}${ API_INS}`, {
                ...
                data: {
                      siguientefamiliaarticulo:values.siguientefamiliaarticulo,
                      siguientefamiliaproducto:values.siguientefamiliaproducto,
                      iva:values.iva,
                      mesproceso:values.mesproceso,
                      comportamientogeneral:values.comportamientogeneral,
        ...
        tableData[rowData.index] = values;
          ...
          .put(`${URL_BASE}${API_UPD}${rowData.getValue('id')}`, {
            data: {
              ...
              iva:values.iva,
              mesproceso:values.mesproceso,
              diasadicionalperiodoactual:values.diasadicionalperiodoactual,
              comportamientogeneral:values.comportamientogeneral,
              empresa:values.empresa
...
//    };
   ...
   const handleDeleteRow = useCallback(
    ...
    const columns = useMemo(
      () => [
        ...
        // },
        {
          accessorKey: 'siguientefamiliaarticulo',
          header: 'siguientefamiliaarticulo',
          size: 140,

        },
        {
          accessorKey: 'siguientefamiliaproducto',
          header: 'siguientefamiliaproducto',
          size: 140,
        ...
        {
          accessorKey: 'diasadicionalperiodoactual',
          header: 'dias adicional periodo actual',
          size: 140,

        },                                
        {
          accessorKey: 'comportamientogeneral',
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialParametro.title);
   setSubTitle(inicialParametro.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
            ...
            <Tooltip arrow placement="left" title="Edit">
              <IconButton onClick={() =>{
                 ...
                 const modificar={
                  ...
                  id: row.original.id,
                  siguientefamiliaarticulo:row.original.siguientefamiliaarticulo,
                  siguientefamiliaproducto:row.original.siguientefamiliaproducto,
                  iva:row.original.iva,
                  mesproceso:row.original.mesproceso,
                  diasadicionalperiodoactual:row.original.diasadicionalperiodoactual,
                  comportamientogeneral:row.original.comportamientogeneral,
