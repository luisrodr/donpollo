...
import { inicialDepartamento} from '../../data/makeDataCrud';
...
const API_SEL=process.env.REACT_APP_API_SEL_DEP;
const API_INS=process.env.REACT_APP_API_INS_DEP;
const API_UPD=process.env.REACT_APP_API_UPD_DEP;
const API_DEL=process.env.REACT_APP_API_DEL_DEP;
...
const Departamento = () => {
    ...
    const [inicial, setInicial] = useState(inicialDepartamento); 
   ...
   const handleDeleteRow = useCallback(
      ...
      (row) => {
        ...
        //existe elemento
        if ( re.terminals){
            console.log("busqueda de id a borrar",re.terminals); 
            console.log("largo", re.terminals );
          
            if  ( re.terminals.length >0){
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialDepartamento.title);
   setSubTitle(inicialDepartamento.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
        ...
        renderTopToolbarCustomActions={() => (
          <Button
            ...
            onClick={() => {
              ...
              setInicial(inicialDepartamento);
