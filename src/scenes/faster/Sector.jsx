...
import { inicialSector} from '../../data/makeDataCrud';
...
const API_SEL=process.env.REACT_APP_API_SEL_SEC;
const API_INS=process.env.REACT_APP_API_INS_SEC;
const API_UPD=process.env.REACT_APP_API_UPD_SEC;
const API_DEL=process.env.REACT_APP_API_DEL_SEC;
...
const Sector = () => {
    ...
    const [inicial, setInicial] = useState(inicialSector); 
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialSector.title);
   setSubTitle(inicialSector.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
