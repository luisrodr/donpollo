...
import { inicialAccionTipoDescuento} from '../../data/makeDataCrud';
...
const API_SEL=process.env.REACT_APP_API_SEL_ATD;
const API_INS=process.env.REACT_APP_API_INS_ATD;
const API_UPD=process.env.REACT_APP_API_UPD_ATD;
const API_DEL=process.env.REACT_APP_API_DEL_ATD;

const AccionTipoDescuento = () => {
    ...
    const [inicial, setInicial] = useState(inicialAccionTipoDescuento); 
   ...
   const handleDeleteRow = useCallback(
      ...
      (row) => {
        ...
        //existe elemento
        if ( re.tipodescuentos){
            console.log("busqueda de id a borrar",re.tipodescuentos); 
            console.log("largo", re.tipodescuentos);
          
            if  ( re.tipodescuentos.length >0){
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialAccionTipoDescuento.title);
   setSubTitle(inicialAccionTipoDescuento.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
        ...
        renderTopToolbarCustomActions={() => (
          <Button
            ...
            onClick={() => {
              ...
              setInicial(inicialAccionTipoDescuento);
...
export default AccionTipoDescuento;
