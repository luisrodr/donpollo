...
import { inicialSubFamiliaArticulo} from '../../data/makeDataCrud';
...
import {ModalSubFamiliaArticulo} from './modal/ModalSubFamiliaArticulo';
...
const API_UPD_FAR=process.env.REACT_APP_API_UPD_FAR;

const API_SEL=process.env.REACT_APP_API_SEL_SFA;
const API_INS=process.env.REACT_APP_API_INS_SFA;
const API_UPD=process.env.REACT_APP_API_UPD_SFA;
const API_DEL=process.env.REACT_APP_API_DEL_SFA;

const SubFamiliaArticulo = () => {
    ...
    const [inicial, setInicial] = useState(inicialSubFamiliaArticulo); 
    ...
    const handleCreateNewRow = (values) => {
          ...
          const idfamilia=familiaData.find(element=>element.descripcion===values.familiaarticulo);
          ...
          axios
              .post(`${URL_BASE}${API_INS}`, {
                ...
                data: {
                  ...
                  familiaarticulo: idfamilia.id,
                  siguientecodigo:values.siguientecodigo,
              ...
              .then((response) => {
                ...
                values.familiaarticulo=response.data.data.familiaarticulo;
                console.log("reemplazando familiaarticulo =========>",values.familiaarticulo);  
                
                tableData.push(values);
                setTableData([...tableData]);
                
                updateSiguienteFamilia(response.data.data.familiaarticulo.id,
                  response.data.data.familiaarticulo.siguientesubfamilia);
    ...
    const handleEdit= async (values ) => {
        ...
        console.log("id famiia ",idfamilia);
        values.familiaarticulo={id:idfamilia.id,descripcion:idfamilia.descripcion};
   ...
   const handleDeleteRow = useCallback(
    ...
    const columns = useMemo(
      () => [
        ...
        {
          accessorKey: 'familiaarticulo.descripcion',
          header: 'familia_articulo',
          size: 140,
        ...
        {
          accessorKey: 'siguientecodigo',
          header: 'siguiente_codigo_articulo',
          size: 140,
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialSubFamiliaArticulo.title);
   setSubTitle(inicialSubFamiliaArticulo.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
   ...
   const cargaStrapi=async()=>{
       ...
       .then(({ data }) => {
         ...
         console.log("subfamart",data.data);
            ...
            <Tooltip arrow placement="left" title="Edit">
              <IconButton onClick={() =>{
                 ...
                 const modificar={
                  ...
                  familiaarticulo:  row.original.familiaarticulo,
                  siguientecodigo: row.original.siguientecodigo
        ...
        renderTopToolbarCustomActions={() => (
          <Button
            ...
            onClick={() => {
              ...
              console.log("Nuevo....",inicialSubFamiliaArticulo);
              setInicial(inicialSubFamiliaArticulo);
...
export default SubFamiliaArticulo;
