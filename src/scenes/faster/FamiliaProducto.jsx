...
import { inicialFamilia} from '../../data/makeDataCrud';
...
import {ModalFamiliaProducto} from './modal/ModalFamiliaProducto';
...
const API_SEL=process.env.REACT_APP_API_SEL_FPR;
const API_INS=process.env.REACT_APP_API_INS_FPR;
const API_UPD=process.env.REACT_APP_API_UPD_FPR;
const API_DEL=process.env.REACT_APP_API_DEL_FPR;
...
const FamiliaProducto = () => {
    ...
    const [inicial, setInicial] = useState(inicialFamilia); 
       ...
       setIsRefetching(true);
         ...
         .put(`${URL_BASE}${API_UPD_PAR}${idfs}`, {
           data: {
            ...
            siguientefamiliaproducto: fsiguiente+1,
           },
         },{    headers:{
          ...
          axios
              ...
              .then((response) => {
                ...
                updateSiguienteFamiliaParametro(parametro.id,
                  parametro.siguientefamiliaproducto);                
...
*/
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialFamilia.title);
   setSubTitle(inicialFamilia.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
