...
import { inicialAgregadoSubFamilia} from '../../data/makeDataCrud';
...
const API_SEL=process.env.REACT_APP_API_SEL_ASP;
const API_INS=process.env.REACT_APP_API_INS_ASP;
const API_UPD=process.env.REACT_APP_API_UPD_ASP;
const API_DEL=process.env.REACT_APP_API_DEL_ASP;

const AgregadoSubFamiliaProducto = () => {
    ...
    const [inicial, setInicial] = useState(inicialAgregadoSubFamilia); 
    ...
    /*
    const  includes=( searchElement,filtro) =>{
...
*/
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialAgregadoSubFamilia.title);
   setSubTitle(inicialAgregadoSubFamilia.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
        ...
        renderTopToolbarCustomActions={() => (
          <Button
            ...
            onClick={() => {
              ...
              setInicial(inicialAgregadoSubFamilia);
...
export default AgregadoSubFamiliaProducto;
