...
import { inicialZona} from '../../data/makeDataCrud';
...
const API_SEL=process.env.REACT_APP_API_SEL_ZON;
const API_INS=process.env.REACT_APP_API_INS_ZON;
const API_UPD=process.env.REACT_APP_API_UPD_ZON;
const API_DEL=process.env.REACT_APP_API_DEL_ZON;
...
const Zona = () => {
    ...
    const [inicial, setInicial] = useState(inicialZona); 
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialZona.title);
   setSubTitle(inicialZona.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
