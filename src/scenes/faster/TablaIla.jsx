...
import { inicialTablaIla} from '../../data/makeDataCrud';

import {ModalTablaIla} from './modal/ModalTablaIla';

import esUnico   from './helpers/esUnico';
import { AuthContext } from "../../mycontext";

const URL_BASE=process.env.REACT_APP_URL_BASE;
const API_SEL=process.env.REACT_APP_API_SEL_TIL;
const API_INS=process.env.REACT_APP_API_INS_TIL;
const API_UPD=process.env.REACT_APP_API_UPD_TIL;
const API_DEL=process.env.REACT_APP_API_DEL_TIL;
...
const TablaIla = () => {
    ...
    const [inicial, setInicial] = useState(inicialTablaIla); 
...
//    };
 ...
 const csvOptions = {
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialTablaIla.title);
   setSubTitle(inicialTablaIla.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
