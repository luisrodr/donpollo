...
export const ModalFamiliaProducto =({ open, 
  onClose,
   onSubmit,
   onEdit,
   inicial, 
   ...
   parametro}) => {
    ...
    useEffect(() => {
      ...
      if (inicial.id === "new" ){
        formik.setFieldValue("codigo", getCodigoSiguiente(parametro.siguientefamiliaproducto));
       }else{  
  ...
  export default ModalFamiliaProducto;
