...
import { inicialListaPrecio} from '../../data/makeDataCrud';
...
import {ModalListaPrecio} from './modal/ModalListaPrecio';

import { AuthContext } from "../../mycontext";

const URL_BASE=process.env.REACT_APP_URL_BASE;

const API_SEL_CPA=process.env.REACT_APP_API_SEL_CPA;

const API_SEL=process.env.REACT_APP_API_SEL_LPR;
const API_INS=process.env.REACT_APP_API_INS_LPR;
const API_UPD=process.env.REACT_APP_API_UPD_LPR;
const API_DEL=process.env.REACT_APP_API_DEL_LPR;
...
const ListaPrecio = () => {
    ...
    const [inicial, setInicial] = useState(inicialListaPrecio); 
    ...
    const handleCreateNewRow = (values) => {
          ...
          const idcondicionpago=condicionPagoData.find(element=>element.descripcion===values.condicionpago);
          console.log("id condicionPago",idcondicionpago);
          ...
          axios
              .post(`${URL_BASE}${API_INS}`, {
                ...
                data: {
                  ...
                  condicionpago: idcondicionpago.id,
    ...
    const handleEdit= async (values ) => {
        ...
        values.condicionpago={id:idcondicionpago.id,descripcion:idcondicionpago.descripcion};
 ...
 const csvOptions = {
  ...
  const handleExportData = () => {
    ...
    for(let i = 0;i<tableData.length;i++) { 
       ...
       const fila={id: tableData[i].id ,
                   ...
                   condicionpago: tableData[i].condicionpago.descripcion,
                   factor: tableData[i].factor,
                    };
  ...
  const get_data_to_pdf=()=>{
    ...
    for(let i = 0;i<tableData.length;i++) { 
       ...
       const fila=[ tableData[i].id, 
                    ...
                    tableData[i].condicionpago.descripcion,
                    tableData[i].factor,
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialListaPrecio.title);
   setSubTitle(inicialListaPrecio.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
   ...
   const cargaCondicionPago=async()=>{
    ...
    await axios
    .get(`${URL_BASE}${API_SEL_CPA}`,{    headers:{
      Authorization:`Bearer  ${token}`
    }})
    .then(({ data }) => {
