...
import { inicialComunaSii} from '../../data/makeDataCrud';
import {ModalComunaSii} from './modal/ModalComunaSii';


import { AuthContext } from "../../mycontext";

const URL_BASE=process.env.REACT_APP_URL_BASE;
const API_SEL=process.env.REACT_APP_API_SEL_CSI;
const API_INS=process.env.REACT_APP_API_INS_CSI;
const API_UPD=process.env.REACT_APP_API_UPD_CSI;
const API_DEL=process.env.REACT_APP_API_DEL_CSI;
...
const ComunaSii = () => {
    ...
    const [inicial, setInicial] = useState(inicialComunaSii); 
 ...
 const csvOptions = {
  ...
  const handleExportData = () => {
    ...
    for(let i = 0;i<tableData.length;i++) { 
       ...
       const fila={codigo: tableData[i].codigo ,
                  ...
                  codigosii: tableData[i].codigosii,};
  ...
  useEffect(() => { 
   ...
   setTitulomod(''); 
   setTitle(inicialComunaSii.title);
   setSubTitle(inicialComunaSii.subtitle);
   setIsLoading(true);
   setIsRefetching(true);
            ...
            <Tooltip arrow placement="left" title="Edit">
              <IconButton onClick={() =>{
                 ...
                 const modificar={
                  ...
                  codigosii: row.original.codigosii
